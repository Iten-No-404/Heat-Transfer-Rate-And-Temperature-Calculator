            ...
            while True:
                ...
                if Click in (None, 'Quit'):   # if the user clicks Quit
                    ...
                    if not (V[0] and V[1] and V[2] and V[3] and V[4] and V[5] and V[6] and V[7]): 
                        ...
                        T0,TF,K0,B,R0,RF,r,A=float(V[0]),float(V[1]),float(V[2]),float(V[3]),float(V[4]),float(V[5]),float(V[6]),float(V[7])
                        ...
                        if(RF<R0):
                            GUI.popup("The outer radius should be larger than the inner radius")
                            break
                        ...
                        while True:
                            ...
                            if newClick_1 in ( 'Graph'): 
                                ...
                                graph(my_formula, range(int(V[4]), int(V[5])))
